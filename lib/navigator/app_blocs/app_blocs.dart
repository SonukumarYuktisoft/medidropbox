...
class AppBlocs {
  static List<SingleChildWidget> appBloc = [
    ...
    BlocProvider(create: (context) => UploadLabReportBloc(RepoInjectors.labReport)),
    BlocProvider(create: (context) => HealthProfileBloc(RepoInjectors.healthProfileReport))
  ];
}
