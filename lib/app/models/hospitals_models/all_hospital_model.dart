...
AllHospitalResponse allHospitalResponseFromJson(String str) =>
    AllHospitalResponse.fromJson(json.decode(str));

String allHospitalResponseToJson(AllHospitalResponse data) =>
    json.encode(data.toJson());

List<AllHospitalModel> allHospitalModelFromJson(String str) =>
    List<AllHospitalModel>.from(
        json.decode(str).map((x) => AllHospitalModel.fromJson(x)));

String allHospitalModelToJson(List<AllHospitalModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

// New response wrapper class for paginated data
class AllHospitalResponse {
  List<AllHospitalModel>? content;
  int? page;
  int? size;
  int? totalElements;
  int? totalPages;
  ...
  factory AllHospitalResponse.fromJson(Map<String, dynamic> json) =>
      AllHospitalResponse(
        content: json["content"] == null
            ? []
            : List<AllHospitalModel>.from(
                json["content"]!.map((x) => AllHospitalModel.fromJson(x))),
        page: json["page"],
        size: json["size"],
...
class AllHospitalModel {
  ...
  factory AllHospitalModel.fromJson(Map<String, dynamic> json) =>
      AllHospitalModel(
        id: json["id"],
        name: json["name"],
